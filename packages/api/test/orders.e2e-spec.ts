...
import { ProductSearchResponseDto } from 'src/modules/products/dto/search-product-response.dto';
import { CartItem } from 'src/modules/orders/orders.service';
import { faker } from '@faker-js/faker';
import { PlaceOrderResponseDto } from 'src/modules/orders/dto/place-order-response.dto';
